...
- [x] 4.1 Inicializar proyecto Blazor WebAssembly con .NET 10, añadir MudBlazor/Radzen para componentes UI (1h ⚡)
- [x] 4.2 Implementar layout base: sidebar navigation, header, breadcrumbs con Blazor Layout (2h ⚡)
...
- [x] 5.1 Configurar `cm-agent/` con su propio `Dockerfile.mock` + `docker-compose.yml` independiente (1h ⚡)
